...
import { ArrowRight, FolderTree, Layers, Hash } from 'lucide-react';
    ...
    >
      <Link to={`/categories/${category.slug}`}>
        ...
        <div className="relative overflow-hidden border border-gray-900/10 bg-white mb-6">
          ...
          {!category.parentCategory && category.subcategories?.length > 0 && (
            <motion.div
          ...
          <div className="flex items-center justify-center gap-6 text-sm text-gray-500">
            {(category.productsCount || 0) > 0 && (
              <div className="flex items-center gap-1">
                <Layers size={14} />
                <span>{category.productsCount} Artworks</span>
              </div>
            )}
