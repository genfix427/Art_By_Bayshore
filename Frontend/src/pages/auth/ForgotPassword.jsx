      ...
      >
            ...
            {!submitted ? (
              ...
              >
                ...
                <p className="text-secondary/70 mb-6">
                  We've sent password reset instructions to <strong className="text-secondary">{email}</strong>
                </p>
        ...
        {!submitted && (
          ...
          >
            <Link
              to="/login"
              className="text-secondary/70 font-medium relative group inline-flex items-center gap-2"
            >
